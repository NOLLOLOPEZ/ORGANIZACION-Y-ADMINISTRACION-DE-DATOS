...
* Nombre del alumno: Cesar de los Santos Aguilar, Arli Andrei Avendaño Avendaño y Noel López Pérez
* No de control: 20887047, 21887018 y 21887006
*/
...
public static class Program
{
    ...
    {
        alumno_t[] alumno = new alumno_t[3];
        Console.Clear();

        try
        {
            using (StreamReader reader = new StreamReader("C:\\Users\\FRAN\\Desktop\\Libro2.csv"))
            {
                string line;
                int i = 0;
